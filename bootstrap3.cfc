...
component{
	// Layout Variables
	this.name 			= "Bootstrap 3.0 Starter Theme";
	this.description 	= "Bootstrap 3.0 version of their Simple and flexible HTML, CSS, and Javascript for popular user interface components and interactions.";
	this.version		= "3.0";
